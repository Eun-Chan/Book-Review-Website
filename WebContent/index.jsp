         ...
         <div class="thumbnail">
            ...
            <div class="caption">
               ...
               <div id="button-Container">
                  <p> 
                     <a class="btn btn-primary" target="_sub" role="button" id="book-buy0">구매하기</a>
   ...
   <div class="col-sm-6 col-md-3">
      <div class="thumbnail">
        ...
        <div class="caption">
         ...
         <br /><br />
          <p><a href="#" class="btn btn-primary" target="_sub" role="button" id="book-buy1">구매하기</a> <a href="#" class="btn btn-default" role="button" id="detail-Book1">더 보기</a></p>
        </div>
      </div>
   </div>
   ...
   <div class="col-sm-6 col-md-3">
      <div class="thumbnail">
        ...
        <div class="caption">
         ...
         <br /><br />
          <p><a href="#" class="btn btn-primary" target="_sub" role="button" id="book-buy2">구매하기</a> <a href="#" class="btn btn-default" role="button" id="detail-Book2">더 보기</a></p>
        </div>
      </div>
    </div>
   <!-- 네번째 -->
   <div class="col-sm-6 col-md-3">
     <div class="thumbnail">
       ...
       <div class="caption">
         ...
         <br /><br />
         <p><a href="#" class="btn btn-primary" target="_sub" role="button" id="book-buy3">구매하기</a> <a href="#" class="btn btn-default" role="button" id="detail-Book3">더 보기</a></p>
       </div>
     </div>
   </div>
    </div> <!-- rowEnd -->
   ...
   $.ajax({
        ...
        success: function(data){
           console.log(data);
            for(var i in data)
              {
               if(data[i] != null && !(isEmpty(data[i]))) //isEmpty함수가 없기 때문에, 직접 정의한다.(하단에 변수참고)
                 {
                  if(i<5){
                     $("td#bookName"+i).text((data[i].rbBookTitle).length > 10?(data[i].rbBookTitle).substr(0,10)+"…":(data[i].rbBookTitle));
                     $("td#writer"+i).html("<img src=<%=request.getContextPath()%>/images/userGradeImage/"+data[i].userGrade+".svg width='30px' height='30px' alt='userGrade icon'>" + " " + data[i].userNickName);
                     $("td#rbTitle"+i).text(data[i].rbTitle);
                       $("td#readCnt"+i).text(data[i].rbReadCnt);
                       $("td#recommendCnt"+i).text(data[i].rbRecommend);               
                       $("input#rbNo"+i).text(data[i].rbNo);                     
                  }
                    
                    /* 인기 리뷰 */
                    else if(i>=5){
                       console.log(data[i]);
                       $("td#best-bookName"+(i-5)).text((data[i].rbBookTitle).length > 10?(data[i].rbBookTitle).substr(0,10)+"…":(data[i].rbBookTitle));
                       $("td#best-writer"+(i-5)).html("<img src=<%=request.getContextPath()%>/images/userGradeImage/"+data[i].userGrade+".svg width='30px' height='30px' alt='userGrade icon'>" + " " + data[i].userNickName);
                     $("td#best-rbTitle"+(i-5)).text(data[i].rbTitle);
                       $("td#best-readCnt"+(i-5)).text(data[i].rbReadCnt);
                       $("td#best-recommendCnt"+(i-5)).text(data[i].rbRecommend);
                       $("input#best-rbNo"+(i-5)).text(data[i].rbNo);
